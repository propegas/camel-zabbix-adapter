...
public class EventToObjectBean {
	...
	public Event toObject(
			...
			@XPath(value = "/ns:zabbixEvent/ns:value/text()", namespaces = @NamespacePrefix(prefix = "ns", uri = "http://skuf.gosuslugi.ru/mon/") ) String value,
